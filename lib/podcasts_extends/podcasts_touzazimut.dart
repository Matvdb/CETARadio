...
class Podcaststouz extends StatefulWidget {
  const Podcaststouz({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<Podcaststouz> createState() => _PodcaststouzState();
}

class _PodcaststouzState extends State<Podcaststouz> {
