import 'agenda.dart';
import 'info.dart';
import 'package:ceta_radio/news_extends/news_ConcoursDeChant.dart';
import 'package:ceta_radio/news_extends/news_HarnesEnFetes.dart';
import 'package:ceta_radio/news_extends/news_NezRouge.dart';
...
class _InfoSalonLBEState extends State<InfoSalonLBE> {
  final String _accueil = "Salon lu livre et du bien être";
  final Uri _url = Uri.parse('http://www.cetaradio.fr/player/');
